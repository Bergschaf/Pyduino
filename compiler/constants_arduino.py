...
PRIMITIVE_ARRAY_TYPES = ["array<int>", "array<float>", "array<char>", "array<bool>", "array<byte>", "array<long>",
                         "array<double>", "array<short>"]
PRIMITIVE_LIST_TYPES = ["list<int>", "list<float>", "list<char>", "list<bool>", "list<byte>", "list<long>",
                        "list<double>", "list<short>"]
...
ALL_SYNTAX_ELEMENTS = OPERATORS + BRACKETS + [",", ":", "'", '"']

CONDITION_CONDITIONS = ["and", "or"]

WHITESPACE = '" "'

SERIAL_CODE = open("../SerialCommunication/ArduinoSkripts/ArduinoSerial/ArduinoSerial.ino",
                   "r").read()  # TODO make this as static string
